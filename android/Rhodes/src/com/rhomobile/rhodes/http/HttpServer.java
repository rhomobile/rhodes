...
/** 
 * HTTP Server.
 * This is the core class for the HTTP server.
 */
public class HttpServer {
	...
	public synchronized void configure(IHttpHandler handler) throws Exception
	{
		try
		{
            ...
            Log.e(this.getClass().getSimpleName(), "HttpHander could not setServer: " + e.getMessage());
            throw e;
        }
   
        listener = new HttpListener(new InetAddrPort(DEFAULT_HOST + ":" + DEFAULT_PORT.toString()), this);
    ...
    void handle(HttpRequest request, HttpResponse response)
    {
        try 
        {
            ...
            if (handled)
            	Log.d(this.getClass().getSimpleName(), "Request was handled by " + handler);
            else
            	Log.d(this.getClass().getSimpleName(), "Request NOT handled by " + handler);
        ...
        {
            Log.e(this.getClass().getSimpleName(), "request aborted: "+request + " details: " + e.getMessage());
        }
    }
