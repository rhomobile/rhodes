...
#define SWIG_init    Init_<%= name.camel_case %>
#define SWIG_name    "<%= name.camel_case %>"

static VALUE m<%= name.camel_case %>;
...
extern "C"
#endif
SWIGEXPORT void Init_<%= name.camel_case %>(void) {
  size_t i;
  
  SWIG_InitRuntime();
  m<%= name.camel_case %> = rb_define_module("<%= name.camel_case %>");
  ...
  rb_define_module_function(m<%= name.camel_case %>, "native_process_string", _wrap_native_process_string, -1);
  rb_define_module_function(m<%= name.camel_case %>, "calc_summ", _wrap_calc_summ, -1);
}
