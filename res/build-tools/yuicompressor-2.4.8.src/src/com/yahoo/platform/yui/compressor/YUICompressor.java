    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            while(filenames.hasNext()) {
                ...
                String preservedOutputFilename = null;
                ...
                try {
                    ...
                    System.out.println("[YUI] Processing " + inputFilename + ". Output to: " + outputFilename + ". Type: " + type + ".");

                    if ( outputFilename.equals(inputFilename) ) {
                      preservedOutputFilename = outputFilename;
                      outputFilename += ".tmp";
                    }
