...
File.chmod 0700, File.dirname(__FILE__) + "/../bin/get-rhodes-info"
File.chmod 0700, File.dirname(__FILE__) + "/../bin/migrate-rhodes-app"
File.chmod 0700, File.dirname(__FILE__) + "/../bin/rhodes"
File.chmod 0700, File.dirname(__FILE__) + "/../bin/rhodes-setup"
File.chmod 0700, File.dirname(__FILE__) + "/../bin/rhogen"
File.chmod 0700, File.dirname(__FILE__) + "/../bin/set-rhodes-sdk"
File.chmod 0700, File.dirname(__FILE__) + "/../bin/upgrade-rhodes-app"
