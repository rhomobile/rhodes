...
#define SCANNER_LOG_ERROR			PB_LOG_ERROR	///<  A P1 Fault with the Scanner
#define SCANNER_LOG_WARNING			PB_LOG_WARNING	///<  A P2 Fault with the Scanner
#define SCANNER_LOG_INFO			PB_LOG_INFO		///<  A P3 Fault with the Scanner
#define WM_SCAN_EVENT_RHOELEMENTS	WM_SCAN_EVENT	///<  Windows Message fired when the BT scanner connects / disconnects
...
#define MINIMUM_SIGNATURE_IMAGE_QUALITY 1	///<  Minimum value for the Signature Image quality
...
/**
*  JSON Names associated with the decodeEvent.  These names must match those given in the help file.
*/
static WCHAR* szDecodeEventNames[] = 
{
	L"data",
	L"source",
	L"type",
...
/**
*  JSON names assocated with the enumScannerEvent.  These names must match those given in the help file.
*/
static WCHAR* szEnumScannerEventNames[] =
{
	L"scannerArray=deviceName,friendlyName",
	NULL
};
...
/**
*  JSON names associated with the bluetoothStatusEvent.  These names must match those given in the help file.
*/
static WCHAR* szBluetoothStatusEventNames[] = 
{
	L"status",
	NULL
};
...
/**
*  JSON names associated with the rsmGetEvent.  These names must match those given in the help file.
*/
static WCHAR* szRSMGetEventNames[] = 
{
	L"attributeArray",
	NULL
};