...
#ifdef PB_CRADLE_PLG_EXPORTS
#define PB_CRADLE_PLG_API __declspec(dllexport)
#else
#define PB_CRADLE_PLG_API __declspec(dllimport)
#endif
 ...
 */
PB_CRADLE_PLG_API BOOL CALLING_CONVENTION Cradle_Preload(PPBSTRUCT pPBStructure, PPBCORESTRUCT pPBCoreStructure);
 ...
 */
PB_CRADLE_PLG_API BOOL CALLING_CONVENTION Cradle_MetaProc(PBMetaStruct *pbMetaStructure, PPBSTRUCT pPBStructure);
 ...
 */
PB_CRADLE_PLG_API BOOL CALLING_CONVENTION Cradle_Dispose(PPBSTRUCT pPBStructure);
