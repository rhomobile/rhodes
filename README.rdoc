...
This will generate a configuration file and an index.html

  rhogen model <modelname>

This will generate a controller file, and view templates to allow your application to edit model data locally.
...
There is a "tutorial available":[http://rhomobile.com/wiki/index.php?title=Mobilizing_Your_Application_with_Rhomobile] on the "Rhomobile site":http://rhomobile.com
