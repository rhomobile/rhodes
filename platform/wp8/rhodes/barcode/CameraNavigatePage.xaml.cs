...
namespace rhodes
{
    public partial class CameraNavigatePage : PhoneApplicationPage
    {
        ...
        void ShowPopupTextDialog()
        {
            ...
            panelConfirmation.Width  = Application.Current.Host.Content.ActualWidth - 14;
            panelConfirmation.Height = 400;
            ...
            _scanConfirmation.VerticalOffset   = 200;
        ...
        void BarcodeReader_ResultFound(Result obj)
        {
            ...
            if (_processResult.Text == null || !_processResult.Text.Equals(obj.Text))
            {
