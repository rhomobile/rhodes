...
class CWKBrowserEngine :  public rho::IBrowserEngine
{
    DEFINE_LOGCLASS;

private:
    static CWKBrowserEngine* g_hInstance;
...
public:
    ...
    static CWKBrowserEngine* getInstance(HWND hParentWnd, HINSTANCE hInstance);

    CWKBrowserEngine(HWND hParentWnd, HINSTANCE hInstance);
    virtual ~CWKBrowserEngine(void);
