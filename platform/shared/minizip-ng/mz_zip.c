...
#if 1
//TAU
void rhoPlainLogVar(const char* file, int line, int severity, const char* szCategory, const char* format, ... );
#define mz_zip_print(fmt, ...) rhoPlainLogVar( __FILE__, __LINE__, 0, "Minizip", fmt  __VA_OPT__(, ) __VA_ARGS__ )
