...
#define SWIG_init    Init_RhoConf
#define SWIG_name    "RhoConf"

static VALUE mRhoConf;
...
_wrap_set_property_by_name(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "set_property_by_name" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "set_property_by_name" "', argument " "2"" of type '" "char *""'");
  }
  arg2 = (char *)(buf2);
  set_property_by_name(arg1,arg2);
...
_wrap_get_property_by_name(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "get_property_by_name" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
...
_wrap_send_log(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "send_log" "', argument " "1"" of type '" "char const *""'");
    }
    arg1 = (char *)(buf1);
  }
  result = (int)send_log((char const *)arg1);
...
_wrap_read_log(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    ...
    if (!SWIG_IsOK(ecode1)) {
      SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "read_log" "', argument " "1"" of type '" "int""'");
    } 
    arg1 = (int)(val1);
  }
...
_wrap_is_property_exists(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (char *)(buf1);
  result = (int)is_property_exists(arg1);
...
extern "C"
#endif
SWIGEXPORT void Init_RhoConf(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mRhoConf = rb_define_module("RhoConf");
