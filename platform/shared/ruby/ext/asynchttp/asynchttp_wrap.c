...
SWIGINTERN VALUE
_wrap_do_request(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","do_request", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  {
    arg2 = rho_param_fromvalue(argv[1]);
  }
  result = (VALUE)do_request((char const *)arg1,arg2);
  vresult = result;
...
_wrap_cancel(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","cancel", 1, argv[0] ));
    }
    arg1 = (char *)(buf1);
  }
...
SWIGEXPORT void Init_AsyncHttp(void) {
  ...
  rb_define_module_function(mAsyncHttp, "do_request", _wrap_do_request, -1);
