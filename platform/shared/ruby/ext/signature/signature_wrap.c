...
extern void rho_signature_take_signature(char* callback_url);
...
_wrap_take_signature(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "take_signature" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  rho_signature_take_signature(arg1);
