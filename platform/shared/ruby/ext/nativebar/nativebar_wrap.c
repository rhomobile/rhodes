...
#define SWIG_init    Init_NativeBar
#define SWIG_name    "NativeBar"

static VALUE mNativeBar;
...
_wrap_create(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","create", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  {
...
_wrap_switch_tab(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","switch_tab", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  switch_tab(arg1);
  return Qnil;
...
_wrap_set_tab_badge(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","set_tab_badge", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","set_tab_badge", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
...
_wrap_create_native_toolbar(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","create_native_toolbar", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  {
    arg2 = rho_param_fromvalue(argv[1]);
...
_wrap_create_native_tabbar(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","create_native_tabbar", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  {
    arg2 = rho_param_fromvalue(argv[1]);
...
_wrap_native_tabbar_switch_tab(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","native_tabbar_switch_tab", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
...
_wrap_native_tabbar_set_tab_badge(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","native_tabbar_set_tab_badge", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","native_tabbar_set_tab_badge", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
...
extern "C"
#endif
SWIGEXPORT void Init_NativeBar(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mNativeBar = rb_define_module("NativeBar");
