...
#define SWIG_init    Init_GeoLocation
#define SWIG_name    "GeoLocation"
...
SWIGINTERN VALUE
_wrap_longitude(int argc, VALUE *argv, VALUE self) {
  double result;
  VALUE vresult = Qnil;
...
SWIGINTERN VALUE
_wrap_altitude(int argc, VALUE *argv, VALUE self) {
  double result;
  VALUE vresult = Qnil;
...
SWIGINTERN VALUE
_wrap_speed(int argc, VALUE *argv, VALUE self) {
  double result;
  VALUE vresult = Qnil;
...
SWIGINTERN VALUE
_wrap_satellites(int argc, VALUE *argv, VALUE self) {
  int result;
  VALUE vresult = Qnil;
...
SWIGINTERN VALUE
_wrap_accuracy(int argc, VALUE *argv, VALUE self) {
  float result;
  VALUE vresult = Qnil;
...
SWIGINTERN VALUE
_wrap_known_positionq___(int argc, VALUE *argv, VALUE self) {
  int result;
  VALUE vresult = Qnil;
...
SWIGINTERN VALUE
_wrap_set_view_notification(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  int res1 ;
  ...
  set_view_notification((char const *)arg1,arg2,arg3);
...
_wrap_set_notification(int argc, VALUE *argv, VALUE self) {
  ...
  set_notification((char const *)arg1,arg2,arg3);
  if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
  return Qnil;
fail:
...
SWIGINTERN VALUE
_wrap_set_notification_ex(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","set_notification_ex", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  {
  ...
  if (argc > 2) {
    ...
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "char *","set_notification_ex", 3, argv[2] ));
    }
    arg3 = (char *)(buf3);
  }
  set_notification_ex((char const *)arg1,arg2,arg3);
  if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
  {
    rho_param_free(arg2);
  }
...
extern "C"
#endif
SWIGEXPORT void Init_GeoLocation(void) {
  size_t i;
  ...
  rb_define_module_function(mGeoLocation, "latitude", _wrap_latitude, -1);
  rb_define_module_function(mGeoLocation, "longitude", _wrap_longitude, -1);
  rb_define_module_function(mGeoLocation, "altitude", _wrap_altitude, -1);
  rb_define_module_function(mGeoLocation, "speed", _wrap_speed, -1);
  rb_define_module_function(mGeoLocation, "satellites", _wrap_satellites, -1);
  rb_define_module_function(mGeoLocation, "accuracy", _wrap_accuracy, -1);
  ...
  rb_define_module_function(mGeoLocation, "set_notification_ex", _wrap_set_notification_ex, -1);
