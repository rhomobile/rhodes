...
#define SWIG_init    Init_RhoScriptVM
#define SWIG_name    "RhoScriptVM"

static VALUE mRhoScriptVM;
...
extern "C"
#endif
SWIGEXPORT void Init_RhoScriptVM(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mRhoScriptVM = rb_define_module("RhoScriptVM");
