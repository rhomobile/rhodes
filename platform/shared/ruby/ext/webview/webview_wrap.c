...
_wrap_refresh(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    ...
    if (!SWIG_IsOK(ecode1)) {
      SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","refresh", 1, argv[0] ));
    } 
    arg1 = (int)(val1);
  }
  refresh(arg1);
...
_wrap_navigate(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","navigate", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  if (argc > 1) {
    ecode2 = SWIG_AsVal_int(argv[1], &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "int","navigate", 2, argv[1] ));
    } 
    arg2 = (int)(val2);
  }
...
_wrap_execute_js(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","execute_js", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  if (argc > 1) {
    ecode2 = SWIG_AsVal_int(argv[1], &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "int","execute_js", 2, argv[1] ));
    } 
    arg2 = (int)(val2);
  }
  if (arg1) {
...
SWIGINTERN VALUE
_wrap_set_menu_items(int argc, VALUE *argv, VALUE self) {
  VALUE arg1 = (VALUE) 0 ;
...
_wrap_full_screen_mode(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","full_screen_mode", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
...
_wrap_set_cookie(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","set_cookie", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","set_cookie", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
