...
#define SWIG_init    Init_RingtoneManager
#define SWIG_name    "Rho::RingtoneManager"

static VALUE mRingtoneManager;
...
SWIGINTERN VALUE
_wrap_get_all_ringtones(int argc, VALUE *argv, VALUE self) {
  VALUE result;
  VALUE vresult = Qnil;
  ...
  result = (VALUE)get_all_ringtones();
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_play(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char *","play", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  play(arg1);
...
extern "C"
#endif
SWIGEXPORT void Init_RingtoneManager(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mRingtoneManager = rb_define_module("Rho");
  mRingtoneManager = rb_define_module_under(mRingtoneManager, "RingtoneManager");
  ...
  rb_define_module_function(mRingtoneManager, "get_all_ringtones", _wrap_get_all_ringtones, -1);
  rb_define_module_function(mRingtoneManager, "stop", _wrap_stop, -1);
  rb_define_module_function(mRingtoneManager, "play", _wrap_play, -1);
}
