...
#define SWIG_init    Init_RhodesNativeViewManager
#define SWIG_name    "RhodesNativeViewManager"

static VALUE mRhodesNativeViewManager;
...
SWIGINTERN VALUE
_wrap_create_native_view(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  int arg2 ;
  VALUE arg3 = (VALUE) 0 ;
  int res1 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","create_native_view", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  ecode2 = SWIG_AsVal_int(argv[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "int","create_native_view", 2, argv[1] ));
  } 
  arg2 = (int)(val2);
  arg3 = argv[2];
  result = (int)create_native_view((char const *)arg1,arg2,arg3);
...
SWIGINTERN VALUE
_wrap_navigate_native_view(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  char *arg2 = (char *) 0 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","navigate_native_view", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","navigate_native_view", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  navigate_native_view(arg1,(char const *)arg2);
...
SWIGINTERN VALUE
_wrap_destroy_native_view(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","destroy_native_view", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  destroy_native_view(arg1);
  return Qnil;
fail:
  return Qnil;
}
...
extern "C"
#endif
SWIGEXPORT void Init_RhodesNativeViewManager(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mRhodesNativeViewManager = rb_define_module("RhodesNativeViewManager");
  ...
  rb_define_module_function(mRhodesNativeViewManager, "create_native_view", _wrap_create_native_view, -1);
  rb_define_module_function(mRhodesNativeViewManager, "navigate_native_view", _wrap_navigate_native_view, -1);
  rb_define_module_function(mRhodesNativeViewManager, "destroy_native_view", _wrap_destroy_native_view, -1);
}
