...
_wrap_take_picture(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char *","take_picture", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  if (argc > 1) {
    {
...
_wrap_get_camera_info(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","get_camera_info", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
...
SWIGINTERN VALUE
_wrap_save_image_to_device_gallery(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  rho_param *arg2 = (rho_param *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","save_image_to_device_gallery", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  if (argc > 1) {
    {
  ...
  save_image_to_device_gallery((char const *)arg1,arg2);
  if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
  {
    rho_param_free(arg2);
  }
...
SWIGEXPORT void Init_Camera(void) {
  ...
  rb_define_module_function(mCamera, "save_image_to_device_gallery", _wrap_save_image_to_device_gallery, -1);
}
