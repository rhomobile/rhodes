...
#define SWIG_init    Init_MapView
#define SWIG_name    "MapView"

static VALUE mMapView;
...
_wrap_set_file_caching_enable(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","set_file_caching_enable", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
...
extern "C"
#endif
SWIGEXPORT void Init_MapView(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mMapView = rb_define_module("MapView");
  ...
  rb_define_module_function(mMapView, "close", _wrap_close, -1);
