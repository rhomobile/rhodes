...
_wrap_vibrate(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    ...
    if (!SWIG_IsOK(ecode1)) {
      SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","vibrate", 1, argv[0] ));
    } 
    arg1 = (int)(val1);
  }
  vibrate(arg1);
...
_wrap_play_file(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 1) {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","play_file", 2, argv[1] ));
    }
    arg2 = (char *)(buf2);
  }
  play_file(arg1,arg2);
...
_wrap_show_status(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "char *","show_status", 3, argv[2] ));
  }
  arg3 = (char *)(buf3);
  show_status(arg1,arg2,arg3);
  if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
