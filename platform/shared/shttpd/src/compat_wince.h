...
#define _read _WCE_read
#define _write _WCE_write
#define _lseek _WCE_lseek
#define time _WCE_time
#define localtime _WCE_localtime
#define mktime _WCE_mktime
#define gmtime _WCE_gmtime
