...
class ManifestGenerator
  ...
  def initialize(javaPackage, appPackage, hidden, permissions, features = {})
    ...
    unless hidden
      @rhodesActivityIntentFilters << {:act=>'android.intent.action.MAIN', :cat=>['android.intent.category.DEFAULT', 'android.intent.category.LAUNCHER', 'android.intent.category.HOME']}
    end
