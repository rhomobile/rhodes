...
{
    RAWLOGC_ERROR(rho_cast<std::string>(tag).c_str(), rho_cast<std::string>(msg).c_str());
}
...
RHO_GLOBAL void JNICALL Java_com_rhomobile_rhodes_Logger_I
  (JNIEnv *env, jclass, jstring tag, jstring msg)
{
    RAWLOGC_INFO(rho_cast<std::string>(tag).c_str(), rho_cast<std::string>(msg).c_str());
}
...
RHO_GLOBAL void JNICALL Java_com_rhomobile_rhodes_Logger_T
  (JNIEnv *env, jclass, jstring tag, jstring msg)
{
    RAWTRACEC(rho_cast<std::string>(tag).c_str(), rho_cast<std::string>(msg).c_str());
}
