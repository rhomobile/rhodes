...
#download 
echo yes | $ANDROID_HOME/tools/bin/sdkmanager "system-images;android-${RHO_ANDROID_SYS_IMG_LEVEL:-19};default;armeabi-v7a"
echo yes | $ANDROID_HOME/tools/bin/sdkmanager "system-images;android-${RHO_ANDROID_SYS_IMG_LEVEL:-19};google_apis;armeabi-v7a"
