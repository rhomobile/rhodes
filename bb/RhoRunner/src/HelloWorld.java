...
/*package*/ final class HelloWorldScreen extends MainScreen// implements HelloWorldResResource
{
    ...
    public HelloWorldScreen()
    {
        ...
        setTitle(new LabelField("Hello", LabelField.ELLIPSIS | LabelField.USE_ALL_WIDTH));
...
/*	public static class Player extends Persistent { 
String fname;
...
public static class Root extends Persistent { 
Index playerLName;
...
row[0] = "pasy";
Player player = new Player(storage, row);
root.playerLName.put(player.fname.toLowerCase(), player);
storage.commit();
