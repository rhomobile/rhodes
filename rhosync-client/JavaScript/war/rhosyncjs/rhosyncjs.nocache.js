function rhosyncjs(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_45], $intern_54 + $intern_55);
      unflattenKeylistIntoAnswers([$intern_44], $intern_54 + $intern_55);
