...
unsigned long g_iseq_load_sec = 0; //time lapsed in iseq_load (in seconds)
unsigned long g_iseq_load_usec = 0; //time lapsed in iseq_load (in microseconds) 
...
unsigned long g_iseq_eval_sec = 0;
unsigned long g_iseq_eval_usec = 0;

unsigned long g_require_compiled_sec = 0;
unsigned long g_require_compiled_usec = 0;

unsigned long g_ruby_start_sec = 0;
unsigned long g_ruby_start_usec = 0;