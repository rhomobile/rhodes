...
extern "C" VALUE videocapture_native_process_string(const char* str) {

    JNIEnv *env = jnienv();
    jclass cls = rho_find_class(env, "com/videocapture/Videocapture");
...
extern "C" int videocapture_calc_summ(int x, int y) {
	return (x+y);
}
