...
#define SWIG_init    Init_VideoCaptureNative
#define SWIG_name    "VideoCaptureNative"

static VALUE mVideoCaptureNative;
...
extern "C"
#endif
SWIGEXPORT void Init_VideoCaptureNative(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mVideoCaptureNative = rb_define_module("VideoCaptureNative");
  ...
  rb_define_module_function(mVideoCaptureNative, "get_property", _wrap_get_property, -1);
  rb_define_module_function(mVideoCaptureNative, "set_property", _wrap_set_property, -1);
  rb_define_module_function(mVideoCaptureNative, "start", _wrap_start, -1);
  rb_define_module_function(mVideoCaptureNative, "stop", _wrap_stop, -1);
  rb_define_module_function(mVideoCaptureNative, "cancel", _wrap_cancel, -1);
}
