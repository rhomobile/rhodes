...
#define SWIG_init    Init_AudioCaptureNative
#define SWIG_name    "AudioCaptureNative"

static VALUE mAudioCaptureNative;
...
extern "C"
#endif
SWIGEXPORT void Init_AudioCaptureNative(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mAudioCaptureNative = rb_define_module("AudioCaptureNative");
  ...
  rb_define_module_function(mAudioCaptureNative, "get_property", _wrap_get_property, -1);
  rb_define_module_function(mAudioCaptureNative, "set_property", _wrap_set_property, -1);
  rb_define_module_function(mAudioCaptureNative, "start", _wrap_start, -1);
  rb_define_module_function(mAudioCaptureNative, "stop", _wrap_stop, -1);
  rb_define_module_function(mAudioCaptureNative, "cancel", _wrap_cancel, -1);
}
