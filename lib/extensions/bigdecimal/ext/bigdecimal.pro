...
macx {
  ...
  OBJECTS_DIR = ../../../../platform/osx/bin/extensions/bigdecimal
  INCLUDEPATH += ../../../../platform/shared/ruby/iphone
}
win32 {
  DESTDIR = ../../../../platform/win32/bin/extensions
  OBJECTS_DIR = ../../../../platform/win32/bin/extensions/bigdecimal
...
unix:!macx {
    ...
    OBJECTS_DIR = $$PWD/../../../../platform/linux/bin/extensions/bigdecimal
