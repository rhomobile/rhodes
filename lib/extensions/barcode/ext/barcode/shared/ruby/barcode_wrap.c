...
SWIGINTERN VALUE
_wrap_barcode_recognize(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  char *result = 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "barcode_recognize" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = (char *)(buf1);
  result = (char *)barcode_recognize((char const *)arg1);
...
_wrap_take_barcode(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "take_barcode" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = (char *)(buf1);
