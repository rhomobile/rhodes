...
macx {
  ...
  OBJECTS_DIR = ../../../../platform/osx/bin/extensions/digest-sha1
  INCLUDEPATH += ../../../../platform/shared/ruby/iphone
}
win32 {
  DESTDIR = ../../../../platform/win32/bin/extensions
  OBJECTS_DIR = ../../../../platform/win32/bin/extensions/digest-sha1
...
unix:!macx {
    ...
    OBJECTS_DIR = $$PWD/../../../../platform/linux/bin/extensions/digest-sha1
...
HEADERS += defs.h sha1.h

SOURCES += sha1.c sha1init.c
