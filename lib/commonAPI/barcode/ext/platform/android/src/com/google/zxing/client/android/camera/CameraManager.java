...
public final class CameraManager {
  ...
  private static final int MAX_FRAME_WIDTH = 480;//1920 / 8 * 5;//480;
  private static final int MAX_FRAME_HEIGHT = 360;//1080 / 8 * 5;//360;
   ...
   */
  public void openDriver(SurfaceHolder holder, int cameraIndex) throws IOException {
    if (camera == null) {
      if (cameraIndex >= 0) {	
