...
namespace MediaplayerImpl
{
    public class Mediaplayer : IMediaplayerImpl
    {
        public Mediaplayer()
        {
            var _runtime = new MediaplayerRuntimeComponent(this);
        }
    ...
    public class MediaplayerSingleton : IMediaplayerSingletonImpl
    {
        public MediaplayerSingleton()
        {
            var _runtime = new MediaplayerSingletonComponent(this);
        }
    ...
    public class MediaplayerFactory : IMediaplayerFactoryImpl
    {
        public IMediaplayerImpl getImpl() {
            return new Mediaplayer();
        }
        public IMediaplayerSingletonImpl getSingletonImpl() {
            return new MediaplayerSingleton();
        }
    }
}
