...
namespace ConnectionCheckingImpl
{
    public class ConnectionChecking : IConnectionCheckingImpl
    {
        public ConnectionChecking()
        {
            var _runtime = new ConnectionCheckingRuntimeComponent(this);
        }
    ...
    public class ConnectionCheckingSingleton : IConnectionCheckingSingletonImpl
    {
        public ConnectionCheckingSingleton()
        {
            var _runtime = new ConnectionCheckingSingletonComponent(this);
        }
    ...
    public class ConnectionCheckingFactory : IConnectionCheckingFactoryImpl
    {
        public IConnectionCheckingImpl getImpl() {
            return new ConnectionChecking();
        }
        public IConnectionCheckingSingletonImpl getSingletonImpl() {
            return new ConnectionCheckingSingleton();
        }
    }
}
