var Rho = Rho || (function ($) {
    ...
    function callbackHandler(callbackId, resultObj) {
        //Rho.Log.info('Rho.callback_handler: callbackId: "' +callbackId + '"',"JSC");
        var cbId = decodeURIComponent(callbackId);
        //Rho.Log.info('Rho.callback_handler: callback for: ' +cbId,"JSC");
        //Rho.Log.info('Rho.callback_handler: resultObj: ' +resultObj,"JSC");
        ...
        Rho.Log.info('Rho.callback_handler: opts: \n {' + str +'\n}',"JSC");*/
        
        if ( ('object' == typeof opts) && (opts)) {
            Rho.Log.info('Rho.callback_handler: callback found!', "JSC");
