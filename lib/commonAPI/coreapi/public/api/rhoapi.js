var Rho = Rho || (function ($) {
    ...
    function findThisScriptURL(scriptName) {
        var elm = null;
        ...
        return null == elm ? null : elm.getAttribute('src');
    }

    var thisFileURL = findThisScriptURL(thisFileName);
    ...
    var rhoUtil = {
        ...
        debug: {
            ...
            findThisScriptURL: findThisScriptURL,
            thisFileURL: thisFileURL,
            loadApiModule: loadApiModule,
