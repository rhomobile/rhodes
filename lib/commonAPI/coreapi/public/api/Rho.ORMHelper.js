(function ($,rho,rhoUtil) {
  ...
  var createTable = function(source){
    ...
    console.log("inside create table for schema");
  ...
  var syncSource = function(source){
    var db = dbConnection(source['partition']);
    console.log("inside sync source");
  ...
  function initDbSource(db, source){
    ...
    var hash_migrate = {};
    console.log("db_source is: " + db_source);
    if(db_source !== null)
  ...
  function findSrcByname(db_sources,name){
    var res = null;
    console.log("finding source db_sources is: " +db_sources);
  ...
  function createSourceModel(db,source,start_id,blob_attribs){
    ...
    console.log("Inside of createSourceModel");
    ...
    console.log("about to insert into table");
  ...
  function updateSourceModel(db,source,db_source,hash_migrate){
    console.log("inside of updateSourceModel");
