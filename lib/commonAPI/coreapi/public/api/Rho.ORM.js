...
(function ($, rho, rhoUtil) {
  ...
  var ORM = {
    ...
    databaseFullResetEx: function(hsh){
      //TODO receive hash of models and attributes to delete from sources
    },
    databaseFullResetAndLogout: function(){
      //TODO delete all from property bag(sources)
    },
    databaseFullReset: function(restClientInfo,resetLocalModels){
