...
(function ($, rho, rhoUtil) {
    ...
    var impl = (function() {
        ...
        Opal.Database = (function() {
            ...
            var makeWhereParams = function(condition, op) {
              ...
              return {condition: conds.join(' ' + op + ' '), values: values};
            };
            ...
            var newDb = function(dbfile, partition) {
                ...
                var delete_from_table = function(table, condition) {
                    var where = makeWhereParams(condition, 'AND');
                    var query = 'delete from "' + table + '" where ' + where.condition;
                    execute_sql(query, where.values);
                };
            ...
            (function(__base, __super){
              ...
              RHO.$get_src_db = function(src_name) {
                ...
                if ((_a = ((_b = Opal.cvars["@@db"]) == null ? nil : _b)) === false || _a === nil) {
                  (Opal.cvars["@@db"] = __scope.Database.$new("/Users/sv/syncdb.sqlite", "user"))
                };
    ...
    var wrapOpalObject = function(opalObject) {
        return {
            get: function(name) {
                var value = opalObject.$method_missing(Opal.String(name));
                return (value === opalObject.$vars().none) ? undefined : value;
            },
    ...
    var makeModel = function(modelClass) {
        ...
        return {
            ...
            find: function(args) {
                return wrapOpalObjects(opalModel.$find(args));
            },
            deleteAll: function() {
