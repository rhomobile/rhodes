...
(function ($, rho, rhoUtil) {
    ...
    var makeModel = function(modelClass) {
        ...
        sources['$[]='](modelClass, Opal.hash({'sync_type': sync_type, 'partition': partition, 'source_id': sourceId}));

        Opal.Rhom._scope.RhomObjectFactory.$init_object(modelClass);
        var opalModel = Opal.Object._scope[modelClass];
        return {
            create: function(values) {
                return opalModel.$create(Opal.hash(values));
            },
            get: function(name) {
                return opalModel.$method_missing(Opal.String(name));
            },
            set: function(name, value) {
                opalModel.$method_missing(Opal.String(name + '='), Opal.Array(1, value));
                return this;
            },
            find: function(args) {
                return opalModel.$find(args);
            }
        };
    };
