...
extern "C" VALUE coreapi_native_process_string(const char* str) {

    JNIEnv *env = jnienv();
    jclass cls = rho_find_class(env, "com/coreapi/CoreAPI");
...
extern "C" int coreapi_calc_summ(int x, int y) {
	return (x+y);
}
