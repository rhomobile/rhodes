...
void Init_RubyAPI_System(void)
{
    ...
    rb_define_singleton_method(rb_mSystem, "platform", rb_s_System_def_getPlatform, -1);
    rb_define_method(rb_mSystem, "hasCamera", rb_System_getHasCamera, -1);
    rb_define_singleton_method(rb_mSystem, "hasCamera", rb_s_System_def_getHasCamera, -1);
    rb_define_method(rb_mSystem, "screenWidth", rb_System_getScreenWidth, -1);
    rb_define_singleton_method(rb_mSystem, "screenWidth", rb_s_System_def_getScreenWidth, -1);
    rb_define_method(rb_mSystem, "screenHeight", rb_System_getScreenHeight, -1);
    rb_define_singleton_method(rb_mSystem, "screenHeight", rb_s_System_def_getScreenHeight, -1);
    rb_define_method(rb_mSystem, "realScreenWidth", rb_System_getRealScreenWidth, -1);
    rb_define_singleton_method(rb_mSystem, "realScreenWidth", rb_s_System_def_getRealScreenWidth, -1);
    rb_define_method(rb_mSystem, "realScreenHeight", rb_System_getRealScreenHeight, -1);
    rb_define_singleton_method(rb_mSystem, "realScreenHeight", rb_s_System_def_getRealScreenHeight, -1);
    rb_define_method(rb_mSystem, "screenOrientation", rb_System_getScreenOrientation, -1);
    rb_define_singleton_method(rb_mSystem, "screenOrientation", rb_s_System_def_getScreenOrientation, -1);
    rb_define_method(rb_mSystem, "ppiX", rb_System_getPpiX, -1);
    rb_define_singleton_method(rb_mSystem, "ppiX", rb_s_System_def_getPpiX, -1);
    rb_define_method(rb_mSystem, "ppiY", rb_System_getPpiY, -1);
    rb_define_singleton_method(rb_mSystem, "ppiY", rb_s_System_def_getPpiY, -1);
    rb_define_method(rb_mSystem, "phoneNumber", rb_System_getPhoneNumber, -1);
    rb_define_singleton_method(rb_mSystem, "phoneNumber", rb_s_System_def_getPhoneNumber, -1);
    rb_define_method(rb_mSystem, "deviceOwnerEmail", rb_System_getDeviceOwnerEmail, -1);
    rb_define_singleton_method(rb_mSystem, "deviceOwnerEmail", rb_s_System_def_getDeviceOwnerEmail, -1);
    rb_define_method(rb_mSystem, "deviceOwnerName", rb_System_getDeviceOwnerName, -1);
    rb_define_singleton_method(rb_mSystem, "deviceOwnerName", rb_s_System_def_getDeviceOwnerName, -1);
    rb_define_method(rb_mSystem, "devicePushId", rb_System_getDevicePushId, -1);
    rb_define_singleton_method(rb_mSystem, "devicePushId", rb_s_System_def_getDevicePushId, -1);
    rb_define_method(rb_mSystem, "phoneId", rb_System_getPhoneId, -1);
    rb_define_singleton_method(rb_mSystem, "phoneId", rb_s_System_def_getPhoneId, -1);
    rb_define_method(rb_mSystem, "deviceName", rb_System_getDeviceName, -1);
    rb_define_singleton_method(rb_mSystem, "deviceName", rb_s_System_def_getDeviceName, -1);
    rb_define_method(rb_mSystem, "osVersion", rb_System_getOsVersion, -1);
    rb_define_singleton_method(rb_mSystem, "osVersion", rb_s_System_def_getOsVersion, -1);
    rb_define_method(rb_mSystem, "locale", rb_System_getLocale, -1);
    rb_define_singleton_method(rb_mSystem, "locale", rb_s_System_def_getLocale, -1);
    rb_define_method(rb_mSystem, "country", rb_System_getCountry, -1);
    rb_define_singleton_method(rb_mSystem, "country", rb_s_System_def_getCountry, -1);
    rb_define_method(rb_mSystem, "isEmulator", rb_System_getIsEmulator, -1);
    rb_define_singleton_method(rb_mSystem, "isEmulator", rb_s_System_def_getIsEmulator, -1);
    rb_define_method(rb_mSystem, "hasCalendar", rb_System_getHasCalendar, -1);
    rb_define_singleton_method(rb_mSystem, "hasCalendar", rb_s_System_def_getHasCalendar, -1);
    rb_define_method(rb_mSystem, "isMotorolaDevice", rb_System_getIsMotorolaDevice, -1);
    rb_define_singleton_method(rb_mSystem, "isMotorolaDevice", rb_s_System_def_getIsMotorolaDevice, -1);
    rb_define_method(rb_mSystem, "oemInfo", rb_System_getOemInfo, -1);
    rb_define_singleton_method(rb_mSystem, "oemInfo", rb_s_System_def_getOemInfo, -1);
    rb_define_method(rb_mSystem, "uuid", rb_System_getUuid, -1);
    rb_define_singleton_method(rb_mSystem, "uuid", rb_s_System_def_getUuid, -1);
    rb_define_method(rb_mSystem, "applicationIconBadge", rb_System_getApplicationIconBadge, -1);
    rb_define_singleton_method(rb_mSystem, "applicationIconBadge", rb_s_System_def_getApplicationIconBadge, -1);
    rb_define_method(rb_mSystem, "applicationIconBadge=", rb_System_setApplicationIconBadge, -1);
    rb_define_singleton_method(rb_mSystem, "applicationIconBadge=", rb_s_System_def_setApplicationIconBadge, -1);
    rb_define_method(rb_mSystem, "httpProxyURI", rb_System_getHttpProxyURI, -1);
    rb_define_singleton_method(rb_mSystem, "httpProxyURI", rb_s_System_def_getHttpProxyURI, -1);
    rb_define_method(rb_mSystem, "httpProxyURI=", rb_System_setHttpProxyURI, -1);
    rb_define_singleton_method(rb_mSystem, "httpProxyURI=", rb_s_System_def_setHttpProxyURI, -1);
    rb_define_method(rb_mSystem, "lockWindowSize", rb_System_getLockWindowSize, -1);
    rb_define_singleton_method(rb_mSystem, "lockWindowSize", rb_s_System_def_getLockWindowSize, -1);
    rb_define_method(rb_mSystem, "lockWindowSize=", rb_System_setLockWindowSize, -1);
    rb_define_singleton_method(rb_mSystem, "lockWindowSize=", rb_s_System_def_setLockWindowSize, -1);
    rb_define_method(rb_mSystem, "showKeyboard", rb_System_getShowKeyboard, -1);
    rb_define_singleton_method(rb_mSystem, "showKeyboard", rb_s_System_def_getShowKeyboard, -1);
    rb_define_method(rb_mSystem, "showKeyboard=", rb_System_setShowKeyboard, -1);
    rb_define_singleton_method(rb_mSystem, "showKeyboard=", rb_s_System_def_setShowKeyboard, -1);
    rb_define_method(rb_mSystem, "fullScreen", rb_System_getFullScreen, -1);
    rb_define_singleton_method(rb_mSystem, "fullScreen", rb_s_System_def_getFullScreen, -1);
    rb_define_method(rb_mSystem, "fullScreen=", rb_System_setFullScreen, -1);
    rb_define_singleton_method(rb_mSystem, "fullScreen=", rb_s_System_def_setFullScreen, -1);
    rb_define_method(rb_mSystem, "localServerPort", rb_System_getLocalServerPort, -1);
    rb_define_singleton_method(rb_mSystem, "localServerPort", rb_s_System_def_getLocalServerPort, -1);
    rb_define_method(rb_mSystem, "localServerPort=", rb_System_setLocalServerPort, -1);
    rb_define_singleton_method(rb_mSystem, "localServerPort=", rb_s_System_def_setLocalServerPort, -1);
    rb_define_method(rb_mSystem, "freeServerPort", rb_System_getFreeServerPort, -1);
    rb_define_singleton_method(rb_mSystem, "freeServerPort", rb_s_System_def_getFreeServerPort, -1);
    rb_define_method(rb_mSystem, "screenAutoRotate", rb_System_getScreenAutoRotate, -1);
    rb_define_singleton_method(rb_mSystem, "screenAutoRotate", rb_s_System_def_getScreenAutoRotate, -1);
    rb_define_method(rb_mSystem, "screenAutoRotate=", rb_System_setScreenAutoRotate, -1);
    rb_define_singleton_method(rb_mSystem, "screenAutoRotate=", rb_s_System_def_setScreenAutoRotate, -1);
    rb_define_method(rb_mSystem, "hasTouchscreen", rb_System_getHasTouchscreen, -1);
    rb_define_singleton_method(rb_mSystem, "hasTouchscreen", rb_s_System_def_getHasTouchscreen, -1);
    rb_define_method(rb_mSystem, "securityTokenNotPassed", rb_System_getSecurityTokenNotPassed, -1);
    rb_define_singleton_method(rb_mSystem, "securityTokenNotPassed", rb_s_System_def_getSecurityTokenNotPassed, -1);
    rb_define_method(rb_mSystem, "webviewFramework", rb_System_getWebviewFramework, -1);
    rb_define_singleton_method(rb_mSystem, "webviewFramework", rb_s_System_def_getWebviewFramework, -1);
    rb_define_method(rb_mSystem, "screenSleeping", rb_System_getScreenSleeping, -1);
    rb_define_singleton_method(rb_mSystem, "screenSleeping", rb_s_System_def_getScreenSleeping, -1);
    rb_define_method(rb_mSystem, "screenSleeping=", rb_System_setScreenSleeping, -1);
    rb_define_singleton_method(rb_mSystem, "screenSleeping=", rb_s_System_def_setScreenSleeping, -1);
    rb_define_method(rb_mSystem, "hasNetwork", rb_System_getHasNetwork, -1);
    rb_define_singleton_method(rb_mSystem, "hasNetwork", rb_s_System_def_getHasNetwork, -1);
    rb_define_method(rb_mSystem, "hasWifiNetwork", rb_System_getHasWifiNetwork, -1);
    rb_define_singleton_method(rb_mSystem, "hasWifiNetwork", rb_s_System_def_getHasWifiNetwork, -1);
    rb_define_method(rb_mSystem, "hasCellNetwork", rb_System_getHasCellNetwork, -1);
    rb_define_singleton_method(rb_mSystem, "hasCellNetwork", rb_s_System_def_getHasCellNetwork, -1);
    rb_define_method(rb_mSystem, "hasSqlite", rb_System_getHasSqlite, -1);
    rb_define_singleton_method(rb_mSystem, "hasSqlite", rb_s_System_def_getHasSqlite, -1);
    rb_define_method(rb_mSystem, "applicationInstall", rb_System_applicationInstall, -1);
    rb_define_singleton_method(rb_mSystem, "applicationInstall", rb_s_System_def_applicationInstall, -1);
    rb_define_method(rb_mSystem, "isApplicationInstalled", rb_System_isApplicationInstalled, -1);
    rb_define_singleton_method(rb_mSystem, "isApplicationInstalled", rb_s_System_def_isApplicationInstalled, -1);
    rb_define_method(rb_mSystem, "applicationUninstall", rb_System_applicationUninstall, -1);
    rb_define_singleton_method(rb_mSystem, "applicationUninstall", rb_s_System_def_applicationUninstall, -1);
    rb_define_method(rb_mSystem, "getStartParams", rb_System_getStartParams, -1);
    rb_define_singleton_method(rb_mSystem, "getStartParams", rb_s_System_def_getStartParams, -1);
    rb_define_method(rb_mSystem, "openUrl", rb_System_openUrl, -1);
    rb_define_singleton_method(rb_mSystem, "openUrl", rb_s_System_def_openUrl, -1);
    rb_define_method(rb_mSystem, "unzipFile", rb_System_unzipFile, -1);
    rb_define_singleton_method(rb_mSystem, "unzipFile", rb_s_System_def_unzipFile, -1);
    rb_define_method(rb_mSystem, "zipFile", rb_System_zipFile, -1);
    rb_define_singleton_method(rb_mSystem, "zipFile", rb_s_System_def_zipFile, -1);
    rb_define_method(rb_mSystem, "zipFiles", rb_System_zipFiles, -1);
    rb_define_singleton_method(rb_mSystem, "zipFiles", rb_s_System_def_zipFiles, -1);
    rb_define_method(rb_mSystem, "setRegistrySetting", rb_System_setRegistrySetting, -1);
    rb_define_singleton_method(rb_mSystem, "setRegistrySetting", rb_s_System_def_setRegistrySetting, -1);
    rb_define_method(rb_mSystem, "getRegistrySetting", rb_System_getRegistrySetting, -1);
    rb_define_singleton_method(rb_mSystem, "getRegistrySetting", rb_s_System_def_getRegistrySetting, -1);
    rb_define_method(rb_mSystem, "setWindowFrame", rb_System_setWindowFrame, -1);
    rb_define_singleton_method(rb_mSystem, "setWindowFrame", rb_s_System_def_setWindowFrame, -1);
    rb_define_method(rb_mSystem, "setWindowPosition", rb_System_setWindowPosition, -1);
    rb_define_singleton_method(rb_mSystem, "setWindowPosition", rb_s_System_def_setWindowPosition, -1);
    rb_define_method(rb_mSystem, "setWindowSize", rb_System_setWindowSize, -1);
    rb_define_singleton_method(rb_mSystem, "setWindowSize", rb_s_System_def_setWindowSize, -1);
    rb_define_method(rb_mSystem, "bringToFront", rb_System_bringToFront, -1);
    rb_define_singleton_method(rb_mSystem, "bringToFront", rb_s_System_def_bringToFront, -1);
    rb_define_method(rb_mSystem, "replaceCurrentBundle", rb_System_replaceCurrentBundle, -1);
    rb_define_singleton_method(rb_mSystem, "replaceCurrentBundle", rb_s_System_def_replaceCurrentBundle, -1);
    rb_define_method(rb_mSystem, "deleteFolder", rb_System_deleteFolder, -1);
    rb_define_singleton_method(rb_mSystem, "deleteFolder", rb_s_System_def_deleteFolder, -1);
    rb_define_method(rb_mSystem, "setDoNotBackupAttribute", rb_System_setDoNotBackupAttribute, -1);
    rb_define_singleton_method(rb_mSystem, "setDoNotBackupAttribute", rb_s_System_def_setDoNotBackupAttribute, -1);
    rb_define_method(rb_mSystem, "isBlobAttr", rb_System_isBlobAttr, -1);
    rb_define_singleton_method(rb_mSystem, "isBlobAttr", rb_s_System_def_isBlobAttr, -1);
    rb_define_method(rb_mSystem, "updateBlobAttribs", rb_System_updateBlobAttribs, -1);
    rb_define_singleton_method(rb_mSystem, "updateBlobAttribs", rb_s_System_def_updateBlobAttribs, -1);
    rb_define_method(rb_mSystem, "get_locale", rb_System_get_locale, -1);
    rb_define_singleton_method(rb_mSystem, "get_locale", rb_s_System_def_get_locale, -1);
    rb_define_method(rb_mSystem, "setPushNotification", rb_System_setPushNotification, -1);
    rb_define_singleton_method(rb_mSystem, "setPushNotification", rb_s_System_def_setPushNotification, -1);
    rb_define_method(rb_mSystem, "setScreenRotationNotification", rb_System_setScreenRotationNotification, -1);
    rb_define_singleton_method(rb_mSystem, "setScreenRotationNotification", rb_s_System_def_setScreenRotationNotification, -1);
    rb_define_method(rb_mSystem, "exit", rb_System_exit, -1);
    rb_define_singleton_method(rb_mSystem, "exit", rb_s_System_def_exit, -1);
    rb_define_method(rb_mSystem, "set_sleeping", rb_System_set_sleeping, -1);
    rb_define_singleton_method(rb_mSystem, "set_sleeping", rb_s_System_def_set_sleeping, -1);
    rb_define_method(rb_mSystem, "startTimer", rb_System_startTimer, -1);
    rb_define_singleton_method(rb_mSystem, "startTimer", rb_s_System_def_startTimer, -1);
    rb_define_method(rb_mSystem, "stopTimer", rb_System_stopTimer, -1);
    rb_define_singleton_method(rb_mSystem, "stopTimer", rb_s_System_def_stopTimer, -1);
    rb_define_method(rb_mSystem, "setNetworkStatusNotify", rb_System_setNetworkStatusNotify, -1);
    rb_define_singleton_method(rb_mSystem, "setNetworkStatusNotify", rb_s_System_def_setNetworkStatusNotify, -1);
    rb_define_method(rb_mSystem, "clearNetworkStatusNotify", rb_System_clearNetworkStatusNotify, -1);
    rb_define_singleton_method(rb_mSystem, "clearNetworkStatusNotify", rb_s_System_def_clearNetworkStatusNotify, -1);
    rb_define_method(rb_mSystem, "set_http_proxy_url", rb_System_set_http_proxy_url, -1);
    rb_define_singleton_method(rb_mSystem, "set_http_proxy_url", rb_s_System_def_set_http_proxy_url, -1);
    rb_define_method(rb_mSystem, "unset_http_proxy", rb_System_unset_http_proxy, -1);
    rb_define_singleton_method(rb_mSystem, "unset_http_proxy", rb_s_System_def_unset_http_proxy, -1);
    rb_define_method(rb_mSystem, "set_application_icon_badge", rb_System_set_application_icon_badge, -1);
    rb_define_singleton_method(rb_mSystem, "set_application_icon_badge", rb_s_System_def_set_application_icon_badge, -1);
    rb_define_method(rb_mSystem, "runApplication", rb_System_runApplication, -1);
    rb_define_singleton_method(rb_mSystem, "runApplication", rb_s_System_def_runApplication, -1);
    rb_define_method(rb_mSystem, "getProperty", rb_System_getProperty, -1);
    rb_define_singleton_method(rb_mSystem, "getProperty", rb_s_System_def_getProperty, -1);
    rb_define_method(rb_mSystem, "getProperties", rb_System_getProperties, -1);
    rb_define_singleton_method(rb_mSystem, "getProperties", rb_s_System_def_getProperties, -1);
    rb_define_method(rb_mSystem, "getAllProperties", rb_System_getAllProperties, -1);
    rb_define_singleton_method(rb_mSystem, "getAllProperties", rb_s_System_def_getAllProperties, -1);
    rb_define_method(rb_mSystem, "setProperty", rb_System_setProperty, -1);
    rb_define_singleton_method(rb_mSystem, "setProperty", rb_s_System_def_setProperty, -1);
    rb_define_method(rb_mSystem, "setProperties", rb_System_setProperties, -1);
    rb_define_singleton_method(rb_mSystem, "setProperties", rb_s_System_def_setProperties, -1);
    rb_define_method(rb_mSystem, "clearAllProperties", rb_System_clearAllProperties, -1);
    rb_define_singleton_method(rb_mSystem, "clearAllProperties", rb_s_System_def_clearAllProperties, -1);



    rb_define_singleton_method(rb_mSystem, "default", rb_System_s_default, 0);
    rb_define_singleton_method(rb_mSystem, "setDefault", rb_System_s_setDefault, 1);
