...
rb_define_method(rb_cSystem, "getDevicePushId", rb_System_getDevicePushId, -1);
rb_define_singleton_method(rb_cSystem, "getDevicePushId", rb_s_System_def_getDevicePushId, -1);
...
rb_define_method(rb_cSystem, "getFreeServerPort", rb_System_getFreeServerPort, -1);
rb_define_singleton_method(rb_cSystem, "getFreeServerPort", rb_s_System_def_getFreeServerPort, -1);
...
rb_define_method(rb_cSystem, "getHasTouchscreen", rb_System_getHasTouchscreen, -1);
rb_define_singleton_method(rb_cSystem, "getHasTouchscreen", rb_s_System_def_getHasTouchscreen, -1);
rb_define_method(rb_cSystem, "getSecurityTokenNotPassed", rb_System_getSecurityTokenNotPassed, -1);
rb_define_singleton_method(rb_cSystem, "getSecurityTokenNotPassed", rb_s_System_def_getSecurityTokenNotPassed, -1);
