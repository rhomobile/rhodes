...
dir = File.expand_path( File.dirname(File.expand_path(__FILE__)) + "/../bin/RhoBundle")
puts "Rhodes root directory..."
puts dir

pkg_file_path = File.expand_path( File.dirname(File.expand_path(__FILE__)) + "/../rhodes/sis") + "/rhodes_tmp.pkg"
puts "Pkg file path..."
puts pkg_file_path
