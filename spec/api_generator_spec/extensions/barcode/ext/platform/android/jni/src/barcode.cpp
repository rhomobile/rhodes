...
extern "C" VALUE barcode_native_process_string(const char* str) {

    JNIEnv *env = jnienv();
    jclass cls = rho_find_class(env, "com/barcode/Barcode");
...
extern "C" int barcode_calc_summ(int x, int y) {
	return (x+y);
}
