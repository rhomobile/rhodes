...
extern "C" VALUE barcode1_native_process_string(const char* str) {

    JNIEnv *env = jnienv();
    jclass cls = rho_find_class(env, "com/barcode1/Barcode1");
...
extern "C" int barcode1_calc_summ(int x, int y) {
	return (x+y);
}
