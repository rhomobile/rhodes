...
#define SWIG_init    Init_Barcode1
#define SWIG_name    "Barcode1"

static VALUE mBarcode1;
...
extern "C"
#endif
SWIGEXPORT void Init_Barcode1(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mBarcode1 = rb_define_module("Barcode1");
  ...
  rb_define_module_function(mBarcode1, "native_process_string", _wrap_native_process_string, -1);
  rb_define_module_function(mBarcode1, "calc_summ", _wrap_calc_summ, -1);
}
