...
extern "C" VALUE megamodule_native_process_string(const char* str) {

    JNIEnv *env = jnienv();
    jclass cls = rho_find_class(env, "com/megamodule/MegaModule");
...
extern "C" int megamodule_calc_summ(int x, int y) {
	return (x+y);
}
