# XXX Breaks 'load' if these tests are run!
...
#autoload :KSAutoloadB, fixture(File.join(__rhoGetCurrentDir(), __FILE__), "autoload_b.rb")
#
...
#    filename = fixture(File.join(__rhoGetCurrentDir(), __FILE__), "autoload_c.rb")
...
#describe "Kernel.autoload" do
#  before :all do
#    @non_existent = fixture File.join(__rhoGetCurrentDir(), __FILE__), "no_autoload.rb"
#  end
#
#  before :each do
#    @loaded_features = $".dup
