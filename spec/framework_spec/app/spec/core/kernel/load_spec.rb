...
$load_fixture_dir = (File.dirname(File.join(__rhoGetCurrentDir(), __FILE__)) + '/../../fixtures/load')
...
describe "Kernel#load" do
  ...
  it "loads a .rb from an absolute path and returns true" do
    path = File.expand_path(File.dirname(File.join(__rhoGetCurrentDir(), __FILE__)) + '/../../fixtures/load/load_spec_1.rb')
