...
#    eval("File.join(__rhoGetCurrentDir(), __FILE__)", binding).should == File.join(__rhoGetCurrentDir(), __FILE__)
#    eval("File.join(__rhoGetCurrentDir(), __FILE__)", binding, "success").should == "success"
#    eval("eval 'File.join(__rhoGetCurrentDir(), __FILE__)', binding").should == "(eval)"
#    eval("eval 'File.join(__rhoGetCurrentDir(), __FILE__)', binding", binding).should == File.join(__rhoGetCurrentDir(), __FILE__)
#    eval("eval 'File.join(__rhoGetCurrentDir(), __FILE__)', binding", binding, 'success').should == 'success'
#  end
#end
#
#describe "Kernel.eval" do
